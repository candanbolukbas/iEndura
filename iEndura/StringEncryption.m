...
- (void)testSymmetricEncryption
{
	...
	NSLog(@"plaintext string: %@",[[NSString alloc] initWithData:_secretData encoding:NSUTF8StringEncoding]);
	...
	NSLog(@"encoded string ASCII: %@",[[NSString alloc] initWithData:encryptedData encoding:NSUTF8StringEncoding]);
